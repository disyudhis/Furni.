        ...
        <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white"
            ...
            <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #3b5d50;">
                ...
                <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center"
                    style="background-image: url(https://themewagon.github.io/furni/images/couch.png)"></div>
                <!--end::Aside Bottom-->
            </div>
            <!--begin::Aside-->
            <!--begin::Content-->
                        ...
                        <form class="form" method="POST" action="{{ route('register') }}" 
                            ...
                            <div class="form-group">
                                <input required
                                    ...
                                    type="text" placeholder="Name" name="name" autocomplete="off" />
                            </div>
                            <!--end::Form group-->
                            <!--begin::Form group-->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input required
                                    class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6"
                                    type="number" placeholder="Phone" name="phone" autocomplete="off" />
                            </div>
                            <!--end::Form group-->
                            <!--begin::Form group-->
                            <div class="form-group">
